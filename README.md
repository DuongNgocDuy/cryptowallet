...
npm run cc:start -- cryptowallet
# Make a testing call to create a record in the ledger
# Beware that the first call may fail with a timeout! Just happens the first time
hurl invoke cryptowallet cryptowallet_create "{\"name\":\"my first request\",\"id\":\"0001\",\"created\":0,\"modified\":0}"
```
...
npm run cc:package -- cryptowallet org1
# Install to your blockchain - From the root of your project
hurl install cryptowallet node -P ./chaincode-cryptowallet
# Install in debug mode, this will run the chaincode server locally so you can debug
hurl install cryptowallet node -P ./chaincode-cryptowallet --debug

# Upgrade your existing chaincode - From the root of your project
hurl upgrade cryptowallet node 1.2 -P ./chaincode-cryptowallet
```
...
# Upgrade your existing chaincode - From the root of your project
npm run cc:upgrade -- cryptowallet 1.2
```
